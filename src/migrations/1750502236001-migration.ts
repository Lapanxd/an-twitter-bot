...
export class Migration1750502236001 implements MigrationInterface {
  name = 'Migration1750502236001';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "temporary_vote"("id", "uid", "number", "applicant", "subject", "totalVotes", "yesVotes", "noVotes", "abstentions", "date", "status", "amendments", "chatGPTResume", "politicalTheme", "amendmentImportance") SELECT "id", "uid", "number", "applicant", "subject", "totalVotes", "yesVotes", "noVotes", "abstentions", "date", "status", "amendments", "chatGPTResume", "politicalTheme", "amendmentImportance" FROM "vote"`,
    );
    ...
    await queryRunner.query(`DROP INDEX "IDX_27c38eb184ec778efc4cf55e91"`);
    await queryRunner.query(
      `CREATE TABLE "temporary_vote" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "uid" varchar NOT NULL, "number" integer NOT NULL, "applicant" varchar NOT NULL, "subject" varchar NOT NULL, "totalVotes" integer NOT NULL, "yesVotes" integer NOT NULL, "noVotes" integer NOT NULL, "abstentions" integer NOT NULL, "date" datetime NOT NULL, "status" text NOT NULL DEFAULT ('file-downloaded'), "amendments" text NOT NULL DEFAULT ('[]'), "chatGPTResume" text, "politicalTheme" text, "amendmentImportance" text, CONSTRAINT "UQ_91f6ff49fa29244744a54847d1f" UNIQUE ("uid"))`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_vote"("id", "uid", "number", "applicant", "subject", "totalVotes", "yesVotes", "noVotes", "abstentions", "date", "status", "amendments", "chatGPTResume", "politicalTheme", "amendmentImportance") SELECT "id", "uid", "number", "applicant", "subject", "totalVotes", "yesVotes", "noVotes", "abstentions", "date", "status", "amendments", "chatGPTResume", "politicalTheme", "amendmentImportance" FROM "vote"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "vote"("id", "uid", "number", "applicant", "subject", "totalVotes", "yesVotes", "noVotes", "abstentions", "date", "status", "amendments", "chatGPTResume", "politicalTheme", "amendmentImportance") SELECT "id", "uid", "number", "applicant", "subject", "totalVotes", "yesVotes", "noVotes", "abstentions", "date", "status", "amendments", "chatGPTResume", "politicalTheme", "amendmentImportance" FROM "temporary_vote"`,
    );
