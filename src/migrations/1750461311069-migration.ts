...
export class Migration1750461311069 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "temporary_vote"("id", "uid", "number", "applicant", "subject", "totalVotes", "yesVotes", "noVotes", "abstentions", "date", "status", "amendments", "chatGPTResume") SELECT "id", "uid", "number", "applicant", "subject", "totalVotes", "yesVotes", "noVotes", "abstentions", "date", "status", "amendments", "chatGPTResume" FROM "vote"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "vote"("id", "uid", "number", "applicant", "subject", "totalVotes", "yesVotes", "noVotes", "abstentions", "date", "status", "amendments", "chatGPTResume") SELECT "id", "uid", "number", "applicant", "subject", "totalVotes", "yesVotes", "noVotes", "abstentions", "date", "status", "amendments", "chatGPTResume" FROM "temporary_vote"`,
    );
