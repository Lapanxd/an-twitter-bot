...
export class Migration1750429591754 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "temporary_vote"("id", "uid", "number", "applicant", "subject", "totalVotes", "yesVotes", "noVotes", "abstentions", "date", "status", "amendments") SELECT "id", "uid", "number", "applicant", "subject", "totalVotes", "yesVotes", "noVotes", "abstentions", "date", "status", "amendments" FROM "vote"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "vote"("id", "uid", "number", "applicant", "subject", "totalVotes", "yesVotes", "noVotes", "abstentions", "date", "status", "amendments") SELECT "id", "uid", "number", "applicant", "subject", "totalVotes", "yesVotes", "noVotes", "abstentions", "date", "status", "amendments" FROM "temporary_vote"`,
    );
