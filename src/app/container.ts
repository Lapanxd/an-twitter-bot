...
import { GenerateAmendmentPostUseCase } from './use-cases/generate-amendment-post.use-case';
...
// Use Cases
export const publishPostUseCase = PublishPostUseCase.instance;
...
export const generateAmendmentPostUseCase = GenerateAmendmentPostUseCase.instance;
